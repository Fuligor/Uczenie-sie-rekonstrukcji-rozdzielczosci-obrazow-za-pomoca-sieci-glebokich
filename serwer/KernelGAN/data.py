...
from util import create_gradient_map, im2tensor, create_probability_map, nn_interpolation
...
class DataGenerator(Dataset):
    ...
    def __init__(self, conf, gan, image, device):
        self.device = device
    ...
    def next_crop(self, for_g, idx):
        ...
        return im2tensor(crop_im, self.device)
